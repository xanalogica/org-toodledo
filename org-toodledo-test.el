...
(defun org-toodledo-test()
  ...
  (let ((org-toodledo-test-count 0)
    ...
    (let ((buf1 (get-buffer-create "*Org-toodledo-test-1*"))
      ...
      ;; Delete all tasks and then sync in buf2 to make sure
      (org-toodledo-test-message "TEST: Cleanup")
      (org-toodledo-test-cleanup)
      (set-buffer buf2)
      (org-toodledo-test-equal (org-toodledo-sync) '(63 0 63 0 0 0) "Synced in 60 deleted tasks")
